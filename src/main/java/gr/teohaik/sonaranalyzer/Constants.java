...
public class Constants {
    ...
    public static final String[] ruleKeys = {
        "c:UndocumentedApi",	
        "c:ClassName",	
        "c:BooleanEqualityComparison",
        "c:TooLongLine",	
        "c:FileName",	
        "c:StringLiteralDuplicated",	
        "c:TabCharacter",
        "c:MissingNewLineAtEndOfFile",	
        "c:MagicNumber",	
        "c:TooManyLinesOfCodeInFunction",
        "c:MissingCurlyBraces",	
        "common-c:InsufficientLineCoverage",	
        "c:TooManyParameters",
        "c:NestedStatements",	
        "c:UselessParentheses",	
        "c:TooManyLinesOfCodeInFile",	
        "c:SwitchLastCaseIsDefault",
        "c:FileComplexity",	
